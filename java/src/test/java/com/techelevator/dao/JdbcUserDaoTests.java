...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "testemail@gmail.com");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "testemail2@gmail.com");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "testemail3@gmail.com");

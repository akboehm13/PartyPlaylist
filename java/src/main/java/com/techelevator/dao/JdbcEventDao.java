...
public class JdbcEventDao implements EventDao {
    ...
    public List<Event> getAllEvents() {
        ...
        String sql = "SELECT event_id, name, dj_id, host_id, date, description, start_time, end_time FROM \"event\"";
        try {
    ...
    public Event getEventByName(String name) {
        Event event = null;
        String sql = "SELECT event_id, name, dj_id, host_id, date, description, start_time, end_time FROM \"event\" " + "WHERE name = ?";
    ...
    public List<Event> getAllEventsByHostID(int hostId) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT event_id, name, dj_id, host_id, date, description, start_time, end_time FROM \"event\" " + "WHERE host_id = ?";
        try {
    ...
    public Event getEventById(int eventid) {
        Event event = null;
        String sql = "SELECT event_id, name, dj_id, host_id, date, description, start_time, end_time FROM \"event\" " + "WHERE event_id = ?";
    ...
    public List<Event> getAllEventsByDJID(int DJid) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT event_id, name, dj_id, host_id, date, description, start_time, end_time FROM \"event\" " + "WHERE dj_id = ?";
        try {
    ...
    public void createEvent(Event event) {
        String sql = "INSERT INTO \"event\" (name, dj_id, host_id, date, description, start_time, end_time) VALUES(?,?,?,?,?,?,?);";
    ...
    public Event updateEventById(Event event) {
        ...
        String sql = "UPDATE \"event\" SET name=?, dj_id=?, host_id=?, date=?, description=?, start_time=?, end_time=?"+
                " WHERE event_id=?;";
    ...
    private Event mapRowToEvent(SqlRowSet rowSet) {
        ...
        event.setDate(rowSet.getDate("date").toLocalDate());
